	    ...
	    <div class="card">
    		<div class="card-body">
          	<b-row>
                    ...
                    <b-col sm="6">
                        <b-row class="my-1">
                            <b-col sm="4"><label for="input-small">Dari :</label></b-col>
                            <b-col sm="8">
                                <b-form-input id="input-small" size="sm" type="text" placeholder="Sumber Dana" v-model="sumber_dana"></b-form-input>
                            </b-col>
                        </b-row>
                        <b-row class="my-1">
